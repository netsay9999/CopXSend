...
namespace H.Saas.Tools
{
    ...
    {
        public static List<KeyValuePair<string, string>> covertModel(this string model)
        {
            ...
            try
            {
                ...
                var o = JObject.Parse(model.ToString());
                foreach (JToken child in o.Children())
                {
                    var pro = child as JProperty;
                    var val = pro.Value.ToString();
                    list.Add(new KeyValuePair<string, string>(pro.Name, val));
                }
                return list;
            }
            catch
        ...
        public static T ToObject<T>(this string Json)
        {
            ...
            try
            {
                json = Json == null ? default(T) : JsonConvert.DeserializeObject<T>(Json);
            }
            catch
            {
