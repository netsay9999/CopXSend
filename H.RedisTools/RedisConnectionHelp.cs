...
namespace H.RedisTools
{
    ...
    public static class RedisConnectionHelp
    {
        ...
        /// 系统自定义Key前缀
        /// </summary>
        public static readonly string SysCustomKey = Configs.Configuration.GetConnectionString("redisKey") ?? "";

        /// <summary>
        /// 连接字符串
        /// </summary>
        private static readonly string RedisConnectionString = Configs.Configuration.GetConnectionString("redisHosts") ?? "127.0.0.1:6379";
